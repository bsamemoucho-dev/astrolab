...
const UI_EXTRA = {
  ...
  de: {
    pdfHint: "Öffnet das Druckfenster: wähle „Als PDF speichern“. Deaktiviere „Kopf- und Fußzeilen“, um Datum und Adresse zu entfernen.", backShort: "← Meine Deutung", backToReading: "← Zurück zu meiner Deutung", authTitle: "Anmelden", authSubmit: "Anmelden", registerEmailSent: "Konto erstellt. Ein Bestätigungscode wurde dir soeben per E-Mail geschickt.", registerDevCode: "Konto erstellt. Bestätigungscode (Entwicklung): {code}", registerEmailFailed: "Konto erstellt, aber der Code konnte nicht gesendet werden. Versuche es gleich noch einmal; dein Konto besteht bereits.", emailLabel: "E-Mail", passwordLabel: "Passwort",
