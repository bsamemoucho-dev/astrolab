...
test("western natal endpoint calculates and persists reproducible development artifacts", async () => {
  ...
  try {
    ...
    assert.ok(calculated.payload.result.parameters.ruleVersionsCreated.includes("lastro-aspects@1.0.0"));
    assert.ok(calculated.payload.result.parameters.ruleVersionsCreated.includes("lastro-time-margin@1.0.0"));
